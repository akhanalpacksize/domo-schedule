...
from commons import output_dir, DATASET_OWNER_ID, DATA_SET_OWNER_NAME,schedule_report
...
def generate_dataset():
    ...
    dataset_name = "Schedule Report"
    dataset_description = "Contains logs data from script running on VM"
